...
public struct DragSurfaceEntry
{
    ...
    /// <summary>
    /// MeshFilter поверхности для вычисления локальных границ клампа.
    /// </summary>
    [SerializeField]
    private MeshFilter _planeMeshFilter;
    ...
    {
        return new DragSurfaceSolver(_planeRoot, _planeMeshFilter);
    }
}
